...
write.csv(Export_df, file = "Export Clean.csv", row.names = F)
...
write.csv(Import_df, file = "Import Clean.csv", row.names = F)
```
...
write.csv(top_export_df, file = "Top 10 Export Clean.csv", row.names = F)
...
write.csv(top_import_df, file = "Top 10 Import Clean.csv", row.names = F)
```
